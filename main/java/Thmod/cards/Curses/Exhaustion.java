...
public class Exhaustion extends CustomCard
{
    ...
    public Exhaustion()
    {
        super("Exhaustion", Exhaustion.NAME,"img/cards/curse/Exhaustion.png", -2, Exhaustion.DESCRIPTION,CardType.CURSE, CardColor.CURSE, CardRarity.CURSE, CardTarget.NONE);
