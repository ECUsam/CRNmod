...
public class Doubleslain extends CustomCard {
    public static final String ID = "Doubleslain";
    public static final String IMG_PATH = "img/cards/Doubleslain.png";
