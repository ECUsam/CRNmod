...
public class FlyingOrbEffect extends AbstractGameEffect {
    ...
    public CatmullRomSpline<Vector2> crs = new CatmullRomSpline<>();
    public ArrayList<Vector2> controlPoints = new ArrayList<>();
    private static final int TRAIL_ACCURACY = 60;
    public Vector2[] points = new Vector2[60];
    public Vector2 pos;
    ...
    public FlyingOrbEffect(float x, float y, AbstractCreature m) {
        this.img = ImageMaster.GLOW_SPARK_2;
        this.pos = new Vector2(x, y);
        this.target = new Vector2(m.hb.cX - DST_THRESHOLD / 3.0F - 100.0F * Settings.scale, m.hb.cY + MathUtils.random(-50.0F, 50.0F) * Settings.scale);
